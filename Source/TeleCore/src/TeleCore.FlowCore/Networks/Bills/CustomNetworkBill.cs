...
{
    private DefValueStack<Flow.Values.NetworkValueDef, double> _cost;
    ...
    public DefValueStack<Flow.Values.NetworkValueDef, double> Cost => _cost;
    ...
    public DefValueStack<Flow.Values.NetworkValueDef, double> TotalAvailable
    {
        get
        {
    ...
    public void SetCost(DefValueStack<Flow.Values.NetworkValueDef, double> costStack)
    {
        _cost = costStack;
    }
    ...
    private DefValueStack<Flow.Values.NetworkValueDef, double> StackFor(INetworkPart comp)
    {
        return DefValueStack<Flow.Values.NetworkValueDef, double>.Empty;
...
public partial class CustomNetworkBill : IExposable
{
    ...
    //General
    public DefValueStack<Flow.Values.NetworkValueDef, double> byProducts;
    ...
    public CustomNetworkBill Clone()
    {
        ...
        bill._cost = new DefValueStack<Flow.Values.NetworkValueDef, double>(_cost);
        bill._hasBeenPaid = _hasBeenPaid;

        bill.byProducts = new DefValueStack<Flow.Values.NetworkValueDef, double>(byProducts);
