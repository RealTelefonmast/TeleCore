...
public abstract class ClampWorker
{
    ...
    public virtual DefValueStack<Values.NetworkValueDef, double> ClampFunction(
    ...
    [Obsolete]
    public abstract double ClampFunction(FlowInterface<NetworkPart, NetworkVolume, Values.NetworkValueDef> iface, double f, ClampType type);
