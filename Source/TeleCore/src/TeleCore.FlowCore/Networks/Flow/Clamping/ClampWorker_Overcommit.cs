...
public class ClampWorker_Overcommit : ClampWorker
{
    ...
    public override DefValueStack<Values.NetworkValueDef, double> ClampFunction(FlowInterface<NetworkPart, NetworkVolume, Values.NetworkValueDef> iface, DefValueStack<Values.NetworkValueDef, double> f, ClampType type)
    {
        var from = iface.From;
        var to = iface.To;
