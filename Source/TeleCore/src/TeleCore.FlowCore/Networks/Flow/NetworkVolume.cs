...
/// </summary>
public class NetworkVolume : FlowVolume<Values.NetworkValueDef>
{
    public override double CapacityOf(Values.NetworkValueDef? def)
    {
    ...
    public override bool IsFull(Values.NetworkValueDef def)
    {
        if (_config.shareCapacity)
    ...
    protected override double ExcessFor(Values.NetworkValueDef def, double amount)
    {
        if (_config.shareCapacity)
    ...
    public NetworkVolume(FlowVolumeConfig<Values.NetworkValueDef> config) : base(config)
    {
    }
}