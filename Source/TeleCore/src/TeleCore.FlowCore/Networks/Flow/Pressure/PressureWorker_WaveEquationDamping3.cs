...
public class PressureWorker_WaveEquationDamping3 : PressureWorker
{
    ...
    public override DefValueStack<Values.NetworkValueDef, double> FlowFunction(FlowInterface<NetworkPart, NetworkVolume, Values.NetworkValueDef> iface, DefValueStack<Values.NetworkValueDef, double> f)
    {
        var from = iface.From;
        var to = iface.To;
        ...
        {
            return DefValueStack<Values.NetworkValueDef, double>.Empty;
        }
    ...
    public double PressureFunction(NetworkVolume t, Values.NetworkValueDef value)
    {
